...
am4core.ready(function () {
  ...
  $.get(`${window.location.protocol}/api/annotations/chartData1`, function (data) {
    annotation.data = data[0].annotation;
  });
  $("#chartAnnotations1").click(function () {
    $.ajax({
      type: "POST",
      url: `${window.location.protocol}/api/annotations`,
      data: {
        annotation: JSON.stringify(annotation.data),
        chartId: "chartData1"
      },
...
am4core.ready(function () {
  ...
  $.get(`${window.location.protocol}/api/annotations/chartData2`, function (data) {
    annotation.data = data[0].annotation;
  });
  $("#chartAnnotations2").click(function () {
    $.ajax({
      type: "POST",
      url: `${window.location.protocol}/api/annotations`,
      data: {
...
am4core.ready(function () {
  ...
  $.get(`${window.location.protocol}/api/annotations/chartData3`, function (data) {
    annotation.data = data[0].annotation;
  });
  $("#chartAnnotations3").click(function () {
    $.ajax({
      type: "POST",
      url: `${window.location.protocol}/api/annotations`,
      data: {
...
am4core.ready(function () {
  ...
  $.get(`${window.location.protocol}/api/annotations/chartData4`, function (data) {
    annotation.data = data[0].annotation;
  });
  $("#chartAnnotations4").click(function () {
    $.ajax({
      type: "POST",
      url: `${window.location.protocol}/api/annotations`,
      data: {
...
am4core.ready(function () {
  ...
  $.get(`${window.location.protocol}/api/annotations/chartData5`, function (data) {
    annotation.data = data[0].annotation;
  });
  $("#chartAnnotations5").click(function () {
    $.ajax({
      type: "POST",
      url: `${window.location.protocol}/api/annotations`,
      data: {
...
am4core.ready(function () {
  ...
  $.get(`${window.location.protocol}/api/annotations/chartData6`, function (data) {
    annotation.data = data[0].annotation;
  });
  $("#chartAnnotations6").click(function () {
    $.ajax({
      type: "POST",
      url: `${window.location.protocol}/api/annotations`,
      data: {
